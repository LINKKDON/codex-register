...
[!\[Python\](https://img.shields.io/badge/Python-3.10%2B-blue.svg null)](https://www.python.org/)
...
| <br /> | 路径                             | 说明    |
| :----- | ------------------------------ | ----- |
| <br /> | `ws://host/api/ws/logs/{uuid}` | 实时日志流 |
...
- 支付链接生成使用账号 access\_token 鉴权，走全局代理配置
